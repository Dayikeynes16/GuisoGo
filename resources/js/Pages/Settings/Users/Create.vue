...
<template>
    ...
    <AppLayout title="Configuracion">
        ...
        <SettingsLayout>
            <div class="mb-5">
                <h2 class="text-lg font-bold text-gray-900">Nuevo usuario operador</h2>
                <p class="text-sm text-gray-500 mt-0.5">Este usuario solo podra ver pedidos y mapa de las sucursales asignadas.</p>
            </div>
